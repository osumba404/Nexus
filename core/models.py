...
class SiteSettings(models.Model):
    ...
    gnews_api_key = models.CharField(max_length=200, blank=True, help_text='API key from gnews.io')
    currents_api_key = models.CharField(max_length=200, blank=True, help_text='API key from currentsapi.services')
    thenewsapi_key = models.CharField(max_length=200, blank=True, help_text='API key from thenewsapi.com')
